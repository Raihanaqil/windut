;(function (window) {
    ...
    let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY CECEEE SAAYAANGGGG', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAHU KAMU PASTI KESAL', 'TAPI INI BENER ADA YANG ANEH', 'AKU JANJI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO SEMANGAT', 'KAMU PASTI BISA', 'IHHH KAMU KURANG PENCET ITU', 'AYO DONG', 'IYA INI BENER TERAKHIR KOK', 'YASUDAH DEH', 'GOOD NIGHTT CANTTIKKKK', 'PLEASE DONT HESITATE TO LET ME KNOW IF SOMETHING IS BOTHERING YOU', 'TAKE A GOOD REST AND RECHARGE YOUR ENERGY', 'BECAUSE TOMORROW IS A NEW DAY FOR US TO PORSUE DREAMS AND HAPPINESS', 'I HOPE YOU SLEEP SOUNDLY AND FULL OF SWEETDREAMS', 'BYEEEEE SAYAAANGG', 'I LOOOVEEE YYOOUUUU♡♡']
